import { useStore, useClientEffectQrl, inlinedQrl, useLexicalScope, componentQrl } from "@builder.io/qwik";
...
const useTypewriter = ({ words, typingSpeed = 200, deleteSpeed = 100, pauseSpeed = 1e3 }) => {
  ...
  useClientEffectQrl(inlinedQrl(({ track }) => {
    const [deleteSpeed2, pauseSpeed2, store2, typingSpeed2, words2] = useLexicalScope();
...
const Typewriter = /* @__PURE__ */ componentQrl(inlinedQrl((props) => {
